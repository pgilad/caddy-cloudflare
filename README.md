...
<p align="center">
  ...
  <a href="https://caddyserver.com/"><img src="https://img.shields.io/badge/caddy-2.11.3-blue.svg" alt="Caddy 2.11.3" /></a>
...
```bash
docker pull docker.io/pgilad/caddy-cloudflare:2.11.3-alpine
```
...
```bash
docker buildx imagetools inspect docker.io/pgilad/caddy-cloudflare:2.11.3-alpine
```
